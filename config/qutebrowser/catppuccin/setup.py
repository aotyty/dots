...
def setup(c, flavour, samecolorrows = False):
    ...
    # flavours {{{
    # Using gruvbox dark palette (based on https://github.com/morhetz/gruvbox)
    palette = {
        "bg0": "#282828",       # Dark background
        "bg1": "#3c3836",       # Darker background
        "bg2": "#504945",       # Dark background highlights
        "bg3": "#665c54",       # Dark background secondary
        "bg4": "#7c6f64",       # Dark background tertiary
        
        "fg0": "#fbf1c7",       # Light foreground
        "fg1": "#ebdbb2",       # Light foreground secondary
        "fg2": "#d5c4a1",       # Light foreground tertiary
        "fg3": "#bdae93",       # Light foreground quaternary
        "fg4": "#a89984",       # Light foreground disabled
        ...
        # Gruvbox doesn't have direct equivalents for Catppuccin's specific names
        # Mapping common names to gruvbox colors:
        "rosewater": "#fbf1c7",  # Light cream
        "flamingo": "#d3869b",   # Using purple
        "pink": "#d3869b",       # Using purple
        "mauve": "#b16286",      # Using purple_dim
        "maroon": "#cc241d",     # Using red_dim
        "peach": "#fe8019",      # Using orange
        "teal": "#8ec07c",       # Using aqua
        "sky": "#83a598",        # Using blue
        "sapphire": "#458588",   # Using blue_dim
        "lavender": "#83a598",   # Using blue
        "text": "#ebdbb2",       # Using fg1
        "subtext1": "#d5c4a1",   # Using fg2
        "subtext0": "#bdae93",   # Using fg3
        "overlay2": "#a89984",   # Using fg4
        "overlay1": "#7c6f64",   # Using bg4
        "overlay0": "#665c54",   # Using bg3
        "surface2": "#504945",   # Using bg2
        "surface1": "#3c3836",   # Using bg1
        "surface0": "#282828",   # Using bg0
        "base": "#1d2021",       # Even darker than bg0
        "mantle": "#282828",     # Using bg0
        "crust": "#1d2021",      # Using base
    }
    # }}}
